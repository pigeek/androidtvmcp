#!/usr/bin/env python3
"""
Script to send text input to an Android TV device using MCP.
"""
...
async def main():
    """Main function to send text input."""
    common_parser = create_common_parser()
    parser = argparse.ArgumentParser(
        description="Send text input to an Android TV device.",
    ...
    async with MCPClient(server_params) as client:
        ...
        await client.send_mcp_command("atv_input_text", {"text": args.text})
