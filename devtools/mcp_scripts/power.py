#!/usr/bin/env python3
"""
Script to send power commands to an Android TV device using MCP.
"""
...
async def main():
    """Main function to send a power command."""
    common_parser = create_common_parser()
    parser = argparse.ArgumentParser(
        description="Send a power command to an Android TV device.",
    ...
    async with MCPClient(server_params) as client:
        ...
        await client.send_mcp_command("atv_power", {})
